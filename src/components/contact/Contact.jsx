    ...
    return (
        <motion.div className="contact" variants={variants} initial='initial' whileInView='animate' ref={ref}>
            <motion.div className="textContainer" variants={variants} >
                <motion.h1 variants={variants} >Open to Exploring New Challenges and Opportunities</motion.h1>
                <div className="item" variants={variants} >
                    <h2>Email</h2>
                    <span>t.priyadharshini1995@gmail.com</span>
                </div>
            ...
            <div className="formContainer">
                ...
                >
                    ...
                    <textarea rows={8} placeholder='Your Message' required name='message'></textarea>
